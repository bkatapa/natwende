...
public class NatwendeUtils implements Serializable {	
	...
	public void showWarnMessageDlg(String warnMsg) {
		...
		MessageHelper.showMessageDialog(new FacesMessage(FacesMessage.SEVERITY_WARN, "Warning", warnMsg), true);
	}
	...
	public void showErrorMessageDlg(String errMsg) {
		...
		MessageHelper.showMessageDialog(new FacesMessage(FacesMessage.SEVERITY_ERROR, "Error", errMsg), true);
	}
	...
	public void showInfoMessageDlg(String infoMsg, String...args) {
		...
		MessageHelper.showMessageDialog(new FacesMessage(FacesMessage.SEVERITY_INFO, infoTitle, infoMsg), true);
	}
