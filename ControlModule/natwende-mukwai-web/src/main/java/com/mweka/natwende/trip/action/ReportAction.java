...
//						date.set(Calendar.MILLISECOND, 0);
				...
				downloadFile = new ByteArrayContent(os.toByteArray(), "application/octect-stream", reportType.getReportFileName().substring(0,reportType.getReportFileName().indexOf(".jrxml"))+".xls");
