...
public class OperatorRouteLinkAction extends MessageHelper<OperatorRouteLinkVO> {
	...
	public String saveEntity() {
		try {
			...
			RequestContext.getCurrentInstance().update(VAR_SUCCESS_DIALOG_BOX);
			RequestContext.getCurrentInstance().execute(SHOW_SUCCESS_DIALOG_BOX);
		}
		catch (Exception ex) {
	...
	public String closeSuccessDialogBox() {
		RequestContext.getCurrentInstance().execute(HIDE_SUCCESS_DIALOG_BOX);
		return operatorAction.viewEntity();
	}
